...
namespace UEEditor
{
	...
	public class frmUEEMain : System.Windows.Forms.Form
	{
		...
		private DevExpress.XtraGrid.Columns.GridColumn colLVPriceCode;
...
//			MessageBox.Show(str);
		...
		private void InitializeComponent()
		{
			...
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmUEEMain));
			...
			this.colLVPriceCode = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			// 
			// CatalogGridControl.EmbeddedNavigator
			// 
			...
			this.UEBaseCost.DataType = typeof(System.Double);
			// 
			// UEUnit
			// 
			...
			this.UEHandMade.DataType = typeof(System.Byte);
			// 
			// dtCatalogName
			// 
			...
			this.ZBaseCost.DataType = typeof(System.Double);
			// 
			// ZUnit
			// 
			...
			this.CExchange.DataType = typeof(System.Decimal);
			// 
			// dtSections
			// 
			...
			// 
			// JobsGridControl.EmbeddedNavigator
			// 
			...
			// 
			// LogsViewGridControl.EmbeddedNavigator
			// 
			...
			// colLVPriceCode
			// 
			this.colLVPriceCode.Caption = "Код прайса";
			this.colLVPriceCode.FieldName = "LVPriceCode";
			this.colLVPriceCode.Name = "colLVPriceCode";
			this.colLVPriceCode.OptionsColumn.AllowEdit = false;
			this.colLVPriceCode.OptionsColumn.AllowGroup = DevExpress.Utils.DefaultBoolean.False;
			this.colLVPriceCode.OptionsColumn.AllowMove = false;
			this.colLVPriceCode.OptionsColumn.ReadOnly = true;
			this.colLVPriceCode.Visible = true;
			this.colLVPriceCode.VisibleIndex = 3;
			// 
			// colLVForm
			// 
			...
			this.colLVUnform.VisibleIndex = 5;
			// 
			// colLVZero
			// 
			...
			this.colLVAddition.VisibleIndex = 8;
			// 
			// groupBox2
			// 
			...
			// 
			// UnrecExpGridControl.EmbeddedNavigator
			// 
			...
			this.BigNameLabel2.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((System.Byte)(204)));
			...
			// 
			// ZeroGridControl.EmbeddedNavigator
			// 
			...
			// 
			// ForbGridControl.EmbeddedNavigator
			// 
			...
			// 
			// OldFirmsGridControl.EmbeddedNavigator
			// 
